...
namespace 成绩管理系统.DAL
{
    abstract class BaseDAL<T> where T : new()
    {
        ...
        public static bool Drop(T bean, params string[] conditions)
        {
        ...
        public static T FindModel(T bean, params string[] conditions)
        {
            DataTable dataTable = null;
            T t = default(T);
        ...
        protected static string GenerateSql_Delete(T bean, params string[] conditions)
        {
            Type type = typeof(T);
            PropertyInfo[] propertys = type.GetProperties();
        ...
        protected static string GenerateSql_Select(T bean, params string[] conditions)
        {
            Type type = typeof(T);
            PropertyInfo[] propertys = type.GetProperties();
            StringBuilder sql = new StringBuilder();
